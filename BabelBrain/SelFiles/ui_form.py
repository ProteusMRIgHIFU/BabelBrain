...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.TrajectoryTypecomboBox_2 = QComboBox(self.groupBox_2)
        self.TrajectoryTypecomboBox_2.addItem("")
        self.TrajectoryTypecomboBox_2.addItem("")
        self.TrajectoryTypecomboBox_2.setObjectName(u"TrajectoryTypecomboBox_2")
        self.TrajectoryTypecomboBox_2.setGeometry(QRect(90, 34, 116, 30))
        self.TrajectoryTypecomboBox_2.setStyleSheet(u"")
        self.label_2 = QLabel(self.groupBox_2)
        self.label_2.setObjectName(u"label_2")
        self.label_2.setGeometry(QRect(15, 40, 71, 16))
        self.label_3 = QLabel(self.groupBox_2)
        self.label_3.setObjectName(u"label_3")
        self.label_3.setGeometry(QRect(211, 39, 71, 16))
        self.ThermalProfilelineEdit_2 = QLineEdit(self.groupBox_2)
        self.ThermalProfilelineEdit_2.setObjectName(u"ThermalProfilelineEdit_2")
        self.ThermalProfilelineEdit_2.setGeometry(QRect(284, 37, 79, 21))
        self.ThermalProfilelineEdit_2.setStyleSheet(u"")
        self.label_4 = QLabel(self.groupBox_2)
        self.label_4.setObjectName(u"label_4")
        self.label_4.setGeometry(QRect(369, 28, 172, 45))
        self.label_4.setWordWrap(True)
        self.TrajectoryTypecomboBox_3 = QComboBox(self.groupBox_2)
        self.TrajectoryTypecomboBox_3.addItem("")
        self.TrajectoryTypecomboBox_3.addItem("")
        self.TrajectoryTypecomboBox_3.addItem("")
        self.TrajectoryTypecomboBox_3.addItem("")
        self.TrajectoryTypecomboBox_3.setObjectName(u"TrajectoryTypecomboBox_3")
        self.TrajectoryTypecomboBox_3.setGeometry(QRect(688, 35, 104, 30))
        self.TrajectoryTypecomboBox_3.setStyleSheet(u"")
        self.label_5 = QLabel(self.groupBox_2)
        self.label_5.setObjectName(u"label_5")
        self.label_5.setGeometry(QRect(573, 41, 116, 16))
        self.label_6 = QLabel(self.groupBox_2)
        self.label_6.setObjectName(u"label_6")
        self.label_6.setGeometry(QRect(791, 27, 207, 59))
...
"profile ...", None))
        ...
        self.groupBox_2.setTitle(QCoreApplication.translate("Dialog", u"Transducer and GPU engine", None))
        self.TrajectoryTypecomboBox_2.setItemText(0, QCoreApplication.translate("Dialog", u"CTX-500", None))
        self.TrajectoryTypecomboBox_2.setItemText(1, QCoreApplication.translate("Dialog", u"H317", None))

        self.label_2.setText(QCoreApplication.translate("Dialog", u"Transducer", None))
        self.label_3.setText(QCoreApplication.translate("Dialog", u"GPU name", None))
        self.ThermalProfilelineEdit_2.setText(QCoreApplication.translate("Dialog", u"M1", None))
        self.label_4.setText(QCoreApplication.translate("Dialog", u"Type GPU string ID such as \"M1\", \"M2\", \"A6000\", etc. ", None))
        self.TrajectoryTypecomboBox_3.setItemText(0, QCoreApplication.translate("Dialog", u"CPU", None))
        self.TrajectoryTypecomboBox_3.setItemText(1, QCoreApplication.translate("Dialog", u"CUDA", None))
        self.TrajectoryTypecomboBox_3.setItemText(2, QCoreApplication.translate("Dialog", u"OpenCL", None))
        self.TrajectoryTypecomboBox_3.setItemText(3, QCoreApplication.translate("Dialog", u"Metal", None))

        self.TrajectoryTypecomboBox_3.setCurrentText(QCoreApplication.translate("Dialog", u"Metal", None))
        self.label_5.setText(QCoreApplication.translate("Dialog", u"GPU/CPU backend", None))
        self.label_6.setText(QCoreApplication.translate("Dialog", u"Select Metal for Mac systems (both ARM and AMD), OpenCL for AMD  in Linux/Win, CUDA for NVidia in Linux/Win", None))
    # retranslateUi
