...
"profile ...", None))
        ...
        self.TransducerTypecomboBox.setItemText(4, QCoreApplication.translate("Dialog", u"Bx55mm", None))
        self.TransducerTypecomboBox.setItemText(5, QCoreApplication.translate("Dialog", u"Bx65mm", None))
        self.TransducerTypecomboBox.setItemText(6, QCoreApplication.translate("Dialog", u"Bx80mm", None))
