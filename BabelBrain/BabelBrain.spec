...
commonDatas=[('Babel_H317/default.yaml','./Babel_H317'),
        ...
        ('Babel_Exablate/default.yaml','./Babel_Exablate'),
        ('default.yaml','./'),
        ('version.txt','./'),
        ('version-gui.txt','./'),
        ...
        ('../TranscranialModeling/ExaNeuroTransducerGeometry.csv','./TranscranialModeling'),
...
commonhidden=['Babel_H317.Babel_H317',
              ...
              'Babel_Exablate.Babel_IExablate',
              ...
              'TranscranialModeling.BabelIntegrationExblate']
