...
class ScrollBars(QWidget):
    ...
    def load_ui(self):
        ...
        self.Widget.IsppaScrollBar1.valueChanged.connect(self._MainApp.update_ac_results)
        self.Widget.IsppaScrollBar1.setEnabled(False)
        self.Widget.IsppaScrollBar2.valueChanged.connect(self._MainApp.update_ac_results)
