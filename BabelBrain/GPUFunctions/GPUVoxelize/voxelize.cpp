                                    ...
                                    uint gid[[thread_position_in_grid]])
{
...
#endif
#ifdef _MLX
    size_t thread_id = thread_position_in_grid.x;
#endif
    ...
    if (thread_id < info_n_triangles) { // every thread works on specific triangles in its stride
        ...
        #endif
        #if defined(_METAL) || defined(_CUDA) || defined(_MLX)
...
kernel void ExtractPoints( device const unsigned int* voxel_table [[ buffer(0) ]],
                           ...
                           device const unsigned int *int_params [[buffer(2)]],
...
#endif
#ifdef _MLX
    size_t k = (size_t)thread_position_in_grid.x;
#endif
