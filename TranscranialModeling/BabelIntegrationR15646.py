...
'''
from .R15646 import generate_r15646_tx
...
class SimulationConditions(BabelIntegrationCONCAVE_PHASEDARRAY.SimulationConditions):
    ...
    def gen_transducer_geom(self):
        self._Tx=generate_r15646_tx(Frequency=self._Frequency,RotationZ=self._RotationZ,FactorEnlarge=self._FactorEnlarge)
        self._TxOrig=generate_r15646_tx(Frequency=self._Frequency,RotationZ=self._RotationZ)
