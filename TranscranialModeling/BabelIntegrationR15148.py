...
'''
from .R15148 import generate_r15148_tx
...
class SimulationConditions(BabelIntegrationCONCAVE_PHASEDARRAY.SimulationConditions):
    ...
    def gen_transducer_geom(self):
        self._Tx=generate_r15148_tx(Frequency=self._Frequency,RotationZ=self._RotationZ,FactorEnlarge=self._FactorEnlarge)
        self._TxOrig=generate_r15148_tx(Frequency=self._Frequency,RotationZ=self._RotationZ)
