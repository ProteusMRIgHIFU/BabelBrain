...
" Tests/config.ini
pytest -k "test_full_pipeline_normal and Metal and ((H317 and 250) or CTX_500) and None" -m "basic_babelbrain_params"
conda deactivate
...
" Tests/config.ini
pytest -k "test_full_pipeline_normal and MLX and ((H317 and 250) or CTX_500) and None" -m "basic_babelbrain_params"
