...
def test_wait_for_file(set_up_file_manager,get_example_data,tmpdir,caplog):
...
def test_generate_hash(set_up_file_manager, tmpdir):
...
def test_generate_hash_file_not_found(set_up_file_manager):
...
def test_generate_hash_read_error(set_up_file_manager, tmpdir):
...
def test_nibabel_to_sitk(dataset,set_up_file_manager,extract_sitk_info,compare_data):
...
def test_sitk_to_nibabel(dataset,set_up_file_manager,extract_nib_info,compare_data):
...
def test_check_reuse_files_no_files(scan_type,set_up_file_manager,capfd):
...
def test_check_reuse_files_valid(scan_type,set_up_file_manager,get_example_data):
...
def test_check_reuse_files_different_CT_type(scan_type,second_scan_type,set_up_file_manager,get_example_data,capfd):
...
def test_check_reuse_files_different_HU_threshold(scan_type,set_up_file_manager,get_example_data,capfd):
...
def test_check_reuse_files_different_pCT_range(scan_type,set_up_file_manager,get_example_data,capfd):
